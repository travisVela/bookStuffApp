...
let PlaceDetailPage = class PlaceDetailPage {
    constructor(router, navCtrl, route, placesService, modalCtrl, actionSheetCtrl, bookingService, loadingCrtl, authService, alertCtrl) {
        this.router = router;
        ...
        this.modalCtrl
            ...
            if (res.role === 'confirm') {
                this.loadingCrtl.create({
                    ...
                    this.bookingService.addBooking(this.place.id, this.place.title, this.place.imgUrl, data.firstName, data.lastName, data.guestNumber, data.bookedFrom, data.bookedTo).subscribe(() => {
                        loadingEl.dismiss();
                    });
                });
            }
