...
var Booking = /** @class */ (function () {
    function Booking(id, placeId, userId, placeTitle, placeImgUrl, firstName, lastName, numOfGuests, bookedFrom, bookedTo) {
        this.id = id;
    ...
    Booking.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: String },
        { type: String },
...
var BookingService = /** @class */ (function () {
    ...
    BookingService.prototype.addBooking = function (placeId, placeTitle, placeImgUrl, firstName, lastName, numOfGuests, bookedFrom, bookedTo) {
        var _this = this;
        var generatedId;
        var newBooking = new _booking_model__WEBPACK_IMPORTED_MODULE_2__["Booking"](Math.random().toString(), placeId, this.authService.userId, placeTitle, placeImgUrl, firstName, lastName, numOfGuests, bookedFrom, bookedTo);
        return this.http.post('https://bookstuffapp.firebaseio.com/bookings.json', tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, newBooking, { id: null })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (res) {
    ...
    BookingService.prototype.cancelBooking = function (bookingId) {
        var _this = this;
        return this.http.delete("https://bookstuffapp.firebaseio.com/bookings/" + bookingId + ".json").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (res) {
            return _this.bookings;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (bookings) {
    ...
    BookingService.prototype.fetchBookings = function () {
        var _this = this;
        return this.http
            .get("https://bookstuffapp.firebaseio.com/bookings.json?OrderBy=\"userId\"&equalto=\"" + this.authService.userId + "\"").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (bookingData) {
            var bookings = [];
